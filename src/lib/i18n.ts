...
export const translations = {
  'es-ES': {
    ...
    'landing.headline': 'Detén el estrés. Recupera tu equilibrio emocional en solo 3 días.',
    'landing.subtitle': 'Un entrenamiento digital de 3 días diseñado para personas mentalmente agotadas, viven en modo estrés, empiezan hábitos y los abandonan, se tratan con dureza, no tienen tiempo para procesos largos, buscan mejorar su bienestar emocional, con herramientas científicas de 10 minutos al día.',
    'landing.cta': 'QUIERO COMENZAR MI RETO AHORA',
    'landing.microcopy': 'Acceso inmediato por 2 meses',
    // Landing - El Problema
    'landing.problem.title': '¿Tu mente te está pidiendo una pausa urgente?',
    'landing.problem.intro': 'Este Reto de 3 Días es la solución exacta si te reconoces en alguna de estas situaciones:',
    ...
    'landing.problem.point4': 'Simplemente quieres cambiar conductas de manera estructurada: no más intentos sueltos, sin improvisar, guía clara, pasos concretos. Sin depender de la motivación del momento.',
    'landing.problem.point5': 'Buscas ciencia, no magia: Quieres herramientas prácticas para tu salud mental, sin teoría aburrida ni misticismo.',
    'landing.problem.transition': 'Si marcaste al menos una, sigue leyendo.',
    // Landing - La Solución
    'landing.solution.title': 'Una ingeniería inversa hacia la calma',
    'landing.solution.intro': 'No es contenido motivacional al azar. Es una secuencia científica y simplificada:',
    ...
    'landing.solution.day2.desc': 'Es una respuesta estratégica y deliberada frente a la inercia conductual y la procrastinación.',
    'landing.solution.day3.title': 'Autocompasión',
    'landing.solution.day3.desc': 'El bienestar no es quedarse quieto. Es moverte hacia lo que te importa, incluso en días difíciles.',
    // Landing - Autoridad
    'landing.authority.title': 'Ciencia que respalda. Calidez que transforma.',
    'landing.authority.body': 'Tu salud mental no es un experimento. Nuestra metodología integra la evidencia científica y técnicas psicológicas que siguen demostrando su efectividad.',
    'landing.authority.quote': 'Rigor técnico para tu cerebro racional. Empatía humana para tu bienestar emocional.',
    // Landing - Formato
    'landing.format.title': 'Corto. Intenso. Efectivo.',
    'landing.format.3days.label': 'días',
    'landing.format.3days.desc': 'La neuroplasticidad responde a la repetición breve y constante. Es el tiempo propicio para empezar un hábito sin abandonarlo.',
    'landing.format.10min.label': 'minutos',
    ...
    'landing.format.sequence.title': 'Secuencia estratégica, flexibilidad psicológica.',
    'landing.format.sequence.desc': 'No es casualidad. Los 3 días son una secuencia psicológica basada en cómo funciona el cerebro bajo estrés. El cambio sostenible no empieza con presión. Empieza con regulación.',
    'landing.format.pace.title': 'A tu ritmo',
    'landing.format.pace.desc': 'Un programa de salud preventiva que se adapta a ti, avanza cuando puedas, retoma sin perder tu progreso.',
    // Landing - Oferta
    'landing.offer.title': 'El bienestar no debería ser un lujo',
    'landing.offer.body': 'Hemos fijado una inversión simbólica porque creemos que la educación en salud mental debe democratizarse.',
    ...
    'landing.offer.closing': 'La pregunta no es cuánto cuesta. Es cuánto te cuesta seguir ignorando tu estrés.',
    'landing.offer.cta': 'ACCEDER AL RETO DE 3 DÍAS AHORA',
  ...
  'en': {
    ...
    'landing.headline': 'Stop stress. Recover your emotional balance in just 3 days.',
    'landing.subtitle': 'A 3-day digital training designed for mentally exhausted people, living in stress mode, who start habits and abandon them, treat themselves harshly, have no time for long processes, seek to improve their emotional wellbeing, with 10-minute scientific tools per day.',
    'landing.cta': 'I WANT TO START MY CHALLENGE NOW',
    'landing.microcopy': 'Immediate access for 2 months',
    // Landing - The Problem
    'landing.problem.title': 'Is your mind asking for an urgent pause?',
    'landing.problem.intro': 'This 3-Day Challenge is the exact solution if you recognize yourself in any of these situations:',
    ...
    'landing.problem.point4': 'You simply want to change behaviors in a structured way: no more loose attempts, no improvising, clear guidance, concrete steps. Without depending on the motivation of the moment.',
    'landing.problem.point5': 'You seek science, not magic: You want practical tools for your mental health, without boring theory or mysticism.',
    'landing.problem.transition': 'If you checked at least one, keep reading.',
    // Landing - The Solution
    'landing.solution.title': 'Reverse engineering toward calm',
    'landing.solution.intro': 'It\'s not random motivational content. It\'s a simplified scientific sequence:',
    ...
    'landing.solution.day2.desc': 'A strategic and deliberate response to behavioral inertia and procrastination.',
    'landing.solution.day3.title': 'Self-Compassion',
    'landing.solution.day3.desc': 'Wellbeing isn\'t standing still. It\'s moving toward what matters to you, even on difficult days.',
    // Landing - Authority
    'landing.authority.title': 'Science that supports. Warmth that transforms.',
    'landing.authority.body': 'Your mental health is not an experiment. Our methodology integrates scientific evidence and psychological techniques that continue to demonstrate their effectiveness.',
    'landing.authority.quote': 'Technical rigor for your rational brain. Human empathy for your emotional wellbeing.',
    // Landing - Format
    'landing.format.title': 'Short. Intense. Effective.',
    'landing.format.3days.label': 'days',
    'landing.format.3days.desc': 'Neuroplasticity responds to brief and constant repetition. It\'s the right time to start a habit without abandoning it.',
    'landing.format.10min.label': 'minutes',
    ...
    'landing.format.sequence.title': 'Strategic sequence, psychological flexibility.',
    'landing.format.sequence.desc': 'It\'s not a coincidence. The 3 days are a psychological sequence based on how the brain works under stress. Sustainable change doesn\'t start with pressure. It starts with regulation.',
    'landing.format.pace.title': 'At your pace',
    'landing.format.pace.desc': 'A preventive health program that adapts to you, move forward when you can, resume without losing your progress.',
    // Landing - Offer
    'landing.offer.title': 'Wellbeing shouldn\'t be a luxury',
    'landing.offer.body': 'We\'ve set a symbolic investment because we believe mental health education should be democratized.',
    'landing.offer.originalPrice': '$72.900',
    'landing.offer.price': '$32.900',
    'landing.offer.originalLabel': 'Regular Price:',
    'landing.offer.priceLabel': 'Launch Price: Only',
    'landing.offer.closing': 'The question isn\'t how much it costs. It\'s how much it costs you to keep ignoring your stress.',
    'landing.offer.cta': 'ACCESS THE 3-DAY CHALLENGE NOW',
