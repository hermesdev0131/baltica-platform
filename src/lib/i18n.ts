...
export const translations = {
  'es-ES': {
    ...
    'landing.problem.bridge': 'O simplemente buscar cambiar...',
    ...
    // Landing - Autoridad
    'landing.authority.title': '¿Por qué funciona este método?',
    'landing.authority.body': 'No estamos improvisando. Este reto, aparte de las técnicas diarias que son más que reconocidas y practicadas por muchos años, integra principios de la Terapia de Aceptación y Compromiso (ACT) y la Teoría del Marco Relacional (RFT), respaldados por más de 900 estudios aleatorios y citados por la Organización Mundial de la Salud.',
    'landing.authority.also': 'Además:',
    'landing.authority.point1.title': 'Neuroplasticidad',
    'landing.authority.point1.desc': '3 días son suficientes para iniciar la consolidación sináptica temprana.',
    'landing.authority.point2.title': 'Regulación del Sistema Nervioso',
    'landing.authority.point2.desc': 'Prácticas breves que activan el sistema parasimpático y reducen el estrés.',
    'landing.authority.point3.title': 'Intenciones de Implementación',
    'landing.authority.point3.desc': 'Las estrategias "Si-Entonces" duplican la probabilidad de éxito al automatizar tus decisiones.',
    // Landing - Formato
  ...
  'en': {
    ...
    'landing.problem.bridge': 'Or simply looking to change...',
    ...
    // Landing - Authority
    'landing.authority.title': 'Why does this method work?',
    'landing.authority.body': 'We\'re not improvising. This challenge, beyond the daily techniques that are well-recognized and practiced for many years, integrates principles from Acceptance and Commitment Therapy (ACT) and Relational Frame Theory (RFT), backed by over 900 randomized studies and cited by the World Health Organization.',
    'landing.authority.also': 'Furthermore:',
    'landing.authority.point1.title': 'Neuroplasticity',
    'landing.authority.point1.desc': '3 days are enough to initiate early synaptic consolidation.',
    'landing.authority.point2.title': 'Nervous System Regulation',
    'landing.authority.point2.desc': 'Brief practices that activate the parasympathetic system and reduce stress.',
    'landing.authority.point3.title': 'Implementation Intentions',
    'landing.authority.point3.desc': '"If-Then" strategies double the probability of success by automating your decisions.',
    // Landing - Format
